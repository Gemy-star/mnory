    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('size_chart', ckeditor.fields.RichTextField(blank=True, help_text='Add size chart content here (HTML supported)', null=True)),
                ('delivery_return', ckeditor.fields.RichTextField(blank=True, help_text='Add Delivery and return policy (HTML supported)', null=True)),
