...
from shop.models import (
    ...
    Order, OrderItem, ShippingAddress, Payment, MnoryUser  # Import new models
)


@admin.register(MnoryUser)
class MnoryUserAdmin(admin.ModelAdmin):
    list_display = ['username', 'email', 'phone', 'is_customer', 'is_staff', 'date_joined' , 'is_vendor',]
    list_filter = ['is_customer', 'is_staff', 'is_active','is_vendor']
