...
class FreelancerProfile(models.Model):
    ...
    profile_picture = models.ImageField(
        upload_to="freelancer_profiles/", blank=True, null=True
    )
    ...
    languages = models.CharField(
        max_length=200, blank=True, help_text="Languages spoken"
    )
...
class Project(models.Model):
    PROJECT_TYPE_CHOICES = [("fixed", "Fixed Price"), ("hourly", "Hourly Rate")]
    ...
    client = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="projects_posted"
    )
...
class Proposal(models.Model):
    ...
    freelancer = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="proposals_sent"
    )
    ...
    attachments = models.FileField(
        upload_to="proposal_attachments/", blank=True, null=True
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class Contract(models.Model):
    ...
    client = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="contracts_as_client"
    )
    freelancer = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="contracts_as_freelancer"
    )
...
class Message(models.Model):
    sender = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="freelancing_sent_messages"
    )
    recipient = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="freelancing_received_messages"
    )
    project = models.ForeignKey(
        Project,
...
class Notification(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="freelancing_notifications"
    )
